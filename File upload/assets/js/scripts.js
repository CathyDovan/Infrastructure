		...
		userFilesDropzone: {
			...
			initFileUploader: function(base, target) {
				...
				var onyxDropzone = new Dropzone(target, {
	                ...
	                maxFiles: 100,
					maxFilesize: 100,
					//acceptedFiles: "image/*,application/pdf,.doc,.docx,.xls,.xlsx,.csv,.tsv,.ppt,.pptx,.pages,.odt,.rtf,.html",
					acceptedFiles: "application/pdf,.doc,.docx,.xls,.xlsx, .csv,.tsv,.ppt,.pptx,.pages,.odt,.rtf, text/html, .html, .rds",
